...
public class Main {
    ...
    public static void test4(){
        ...
        park.addPerson(ride1, new Person("Ploni Almoni 1", 1));
        park.addPerson(ride1, new Person("Ploni Almoni 2", 2));
        park.addPerson(ride1, new Person("Ploni Almoni 3", 3, new Person("Ploni", 1)));
        park.addPerson(ride1, new Person("Ploni Almoni 4", 4, new Person("Ploni Almoni", 1)));
